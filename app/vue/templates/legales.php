...
<section>
	...
	<h5><?= $titreArticle01; ?><hr></h5><br>
	<p><?= $article01; ?></p>
	</article>

  <article class="row"><br>
	<h5><?= $titreArticle02; ?><hr></h5><br>
	<p><?= $article02; ?></p>
	</article>

	<article class="row"><br>
	<h5><?= $titreArticle03; ?><hr></h5><br>
	<p><?= $article03; ?></p>
	</article>

  <article class="row"><br>
	<h5><?= $titreArticle04; ?><hr></h5><br>
	<p><?= $article04; ?></p>
	</article>

	<article class="row"><br>
	<h5><?= $titreArticle05; ?><hr></h5><br>
	<p><?= $article05; ?></p>
	</article>

  <article class="row"><br>
	<h5><?= $titreArticle06; ?><hr></h5><br>
	<p><?= $article06; ?></p>
	</article>

	<article class="row"><br>
	<h5><?= $titreArticle07; ?><hr></h5><br>
	<p><?= $article07; ?></p>
	</article>

  <article class="row"><br>
	<h5><?= $titreArticle08; ?><hr></h5><br>
	<p><?= $article08; ?></p>
	</article>

  <article class="row"><br>
	<h5><?= $titreArticle09; ?><hr></h5><br>
	<p><?= $article09; ?></p>
	</article>
